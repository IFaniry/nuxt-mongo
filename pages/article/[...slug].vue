    ...
    <div class="banner">
      <div class="container">
        ...
        <div class="article-meta">
          <!-- TODO: store default profile image somewhere -->
          <a href="/profile/eric-simons"
            ><img :src="article?.author?.image || DEFAULT_PROFILE_IMAGE"
          /></a>
          <div class="info">
    ...
    <div class="container page">
      <div class="row article-content">
        <div class="col-md-12">
          ...
          <p>{{ article?.body }}</p>
          <ul v-if="article?.tags?.length" class="tag-list">
...
const isFromMe = computed(
  () => me.value?.username === article.value?.author.username
);
</script>
